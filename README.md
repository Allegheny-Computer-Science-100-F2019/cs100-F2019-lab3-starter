...
called `TipCalculator`, that will produce ten lines of output. The first line of
output will contain the name of the programmer and the date at which the program
was run. The next lines of output will demonstrate that the program can
correctly read from a file and perform computations on the input value,
ultimately perform and displaying the result of a correct tip calculation. As
verified by [Checkstyle](https://github.com/checkstyle/checkstyle), the source
code for the `TipCalculator.java` file must adhere to all of the
requirements given in the [Google Java Style
...
The source code in the `TipCalculator.java` file must also pass additional tests
set by the [GatorGrader tool](https://github.com/GatorEducator/gatorgrader). For
instance, GatorGrader will check to ensure that `TipCalculator` produces exactly
...
Chapter 2 in the course textbook, paying close attention to Sections 2.1 through
2.6, Figure 2.7, and Listing 2.8. Please see the course instructor or one of the
...
following output for the completed version of `TipCalculator`. As long as your
...
```
Gregory M. Kapfhammer Tue Sep 24 10:40:07 EDT 2019
Timothy, welcome to the tip calculator.
The amount of your bill is: $50.0
The percentage you want to tip is: 15.0%
Alright, that means your total tip will be: $7.5
...
- The TipCalculator.java in src/main/java/labthree has at least 10 single-line Java comment(s)
- The TipCalculator.java in src/main/java/labthree has exactly 0 of the `Add Your Name Here` fragment
- The TipCalculator.java in src/main/java/labthree has exactly 0 of the `TODO` fragment
- The TipCalculator.java in src/main/java/labthree has exactly 1 of the `import java.io.File;` fragment
- The TipCalculator.java in src/main/java/labthree has exactly 1 of the `import java.io.FileNotFoundException;` fragment
- The TipCalculator.java in src/main/java/labthree has exactly 1 of the `import java.util.Date;` fragment
- The TipCalculator.java in src/main/java/labthree has exactly 1 of the `new Date()` fragment
- The TipCalculator.java in src/main/java/labthree has exactly 1 of the `nextInt` fragment
- The TipCalculator.java in src/main/java/labthree has exactly 1 of the `nextLine` fragment
- The TipCalculator.java in src/main/java/labthree has exactly 1 of the `package labthree;` fragment
- The TipCalculator.java in src/main/java/labthree has exactly 2 multiple-line Java comment(s)
- The TipCalculator.java in src/main/java/labthree has exactly 2 of the `nextDouble` fragment
- The TipCalculator.java in src/main/java/labthree has exactly 9 of the `println(` fragment
- The command `gradle -q --console plain run` executes correctly
- The command `gradle build` executes correctly
- The command output has exactly 1 of the `$28.75` fragment
- The command output has exactly 1 of the `$50.0` fragment
- The command output has exactly 1 of the `15.0%` fragment
- The command output has exactly 10 lines
- The file TipCalculator.java exists in the src/main/java/labthree directory
...
```
        ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
        ┃ Passed 28/28 (100%) of checks for cs100-F2019-lab3! ┃
        ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
```
...
```
git remote add download git@github.com:Allegheny-Computer-Science-100-F2019/cs100-F2019-lab3-starter.git
```
...
3](https://github.com/Allegheny-Computer-Science-100-F2019/cs100-F2019-lab3-starter)
repository and [raise an
issue](https://github.com/Allegheny-Computer-Science-100-F2019/cs100-F2019-lab3-starter/issues).
